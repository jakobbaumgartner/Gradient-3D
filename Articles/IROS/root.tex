...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{demo-field1.eps} % Replace 'example-image' with the filename of your image
...
\subsection{Drone Example}

\add{EXAMPLE: DRONE MOVING THROUGH THE MAP OF OBSTACLES USING APF}
