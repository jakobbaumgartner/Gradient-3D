...
\add{describe inverse kinematics integration of velocities}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.95\linewidth]{demo-field1c.eps} % Replace 'example-image' with the filename of your image
