...
\thanks{*Corresponding author6}% <-this % stops a space
\thanks{$^{1}$Faculty of Electrical Engineering, University of Ljubljana, Slovenia        
        {\tt\small jakob.baumgartner@fe.uni-lj.si}}%
\thanks{$^{2}$Faculty of Electrical Engineering, University of Ljubljana, Slovenia        
        {\tt\small gregor.klancar@fe.uni-lj.si}}%
}
