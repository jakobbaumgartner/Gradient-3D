...
To get the full velocity of the end effector (EE), \( \mathrm{\vec{v}_{att}} \), translational and rotational velocities are scaled using proportional gains and combined \( k_v \) and \( k_\omega \).
