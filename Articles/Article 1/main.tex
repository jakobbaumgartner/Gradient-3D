...
The fundamental concept of our directional kernels lies in computing the repulsive field individually for each direction within the Cartesian coordinate system. Our filters can be likened to a variation of the Sobel \add{reference} operator, a 2D convolutional \add{reference} filter frequently utilized in computer vision for calculating image gradients at specific points.
