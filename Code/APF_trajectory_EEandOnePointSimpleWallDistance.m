function [joints_positions, EE_positions, goal_distances, q_velocities, ee_velocities, values_APF] = APF_trajectory_EEandOnePointSimpleWallDistance(grid_field, grid_repulsive, space_resolution, goal_point, Tbase, q, varargin)
