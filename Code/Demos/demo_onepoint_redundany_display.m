...
robot_states = [1.50 1 pi/2 0 pi/4 0 -pi/3 0 1.8675 0]; color_arm = "#CC0000";
robot_states = [1.50 10 pi/2 0 pi/4 0 -pi/3 0 1.8675 0]; color_arm = "#73D216";
robot_states = [100 0 0 0 pi/4 0 -pi/3 0 1.8675 0]; color_arm = "#3465A4";
...
[T, Abase, A01, A12, A23, A34, A45, A56, A67] = GeometricRobot(robot_states_hist(end,:));
showRobot(Abase, A01, A12, A23, A34, A45, A56, A67,10*10, color_arm, true)
