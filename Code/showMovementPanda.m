function [f] = showMovementPanda(grid, grid_matrix, grid_APF, joints_positions_APF, EE_positions_APF, Tbase)
    ...
    draw_APF = true; % option to draw APF vector field
    ...
    if draw_APF
        ...
        for i = 1:1:size(APF_interpolated_values,1)
            ...
            APF_handles(i).WData = APF_gradient_values(i,1) * arrow_length;
            APF_handles(i).VData = APF_gradient_values(i,2) * arrow_length;
            APF_handles(i).UData = APF_gradient_values(i,3) * arrow_length;
